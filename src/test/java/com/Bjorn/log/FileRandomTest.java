...
public class FileRandomTest {
    ...
    private FileRandomLog randomAccessLog;

    @BeforeEach
    void setUp() throws IOException {
        Files.deleteIfExists(TEST_FILE_PATH);
        Files.createFile(TEST_FILE_PATH);
        randomAccessLog = new FileRandomLog(TEST_FILE_NAME);
    }
    ...
    @Test
    void givenLogWithContent_whenAppend_thenAppendsCorrectly() throws Exception {
        // Given
    ...
    @Test
    void givenLogWithContent_whenReadSubset_thenReturnsSubset() throws Exception {
        // Given
        // A log with existing content
    ...
    void givenInvalidRange_whenRead_thenThrowsInvalidRangeException() throws IOException {
        ...
        // When/Then
        assertThrows(Exception.class, () -> randomAccessLog.read(0, -1));
        assertThrows(Exception.class, () -> randomAccessLog.read(-1, 5));
        assertThrows(Exception.class, () -> randomAccessLog.read(15, 10));
        assertThrows(Exception.class, () -> randomAccessLog.read(2, 10));
        assertThrows(Exception.class, () -> randomAccessLog.read(0, 6));
    }
    ...
    @Test
    void givenLogWithContent_whenReadSegment_thenReturnsCorrectSegment() throws Exception {
        // Given
        // A log with existing content
        ...
        Pointer firstFilePointer = randomAccessLog.append(firstSegment.getBytes());
        Pointer secondFilePointer = randomAccessLog.append(secondSegment.getBytes());
    ...
    void givenLogWithContent_whenReadSegmentWithInvalidOffset_thenThrowsInvalidRangeException() throws IOException {
        ...
        // When/Then
        assertThrows(Exception.class, () -> randomAccessLog.readSegment(-1));
        assertThrows(Exception.class, () -> randomAccessLog.readSegment(100));
    }
    ...
    void givenEmptyLog_whenReadSegment_thenThrowsInvalidRangeException() {
        ...
        // When/Then
        assertThrows(Exception.class, () -> randomAccessLog.readSegment(0));
    }
    ...
    void givenLogWithContent_whenAppend_thenReturnsCorrectFilePointer() throws IOException {
        ...
        // When
        Pointer fp1 = randomAccessLog.append("Hello".getBytes());
        Pointer fp2 = randomAccessLog.append("World".getBytes());
